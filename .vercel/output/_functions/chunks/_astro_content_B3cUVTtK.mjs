import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, A as AstroError, R as RenderUndefinedEntryError, u as unescapeHTML, U as UnknownContentCollectionError, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, e as renderComponent } from './astro/server_DxIRt11M.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
...
}, "/Users/danielgarcia/Downloads/katuq_landing/src/components/ui/Badge.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D38VfXQU.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://astro-theme-one.vercel.app/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_rrntVZgH.mjs').then(n => n._);
...
export { $$Badge as $, getCollection as g };
